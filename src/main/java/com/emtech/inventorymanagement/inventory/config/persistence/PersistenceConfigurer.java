package com.emtech.inventorymanagement.inventory.config.persistence;

import com.emtech.inventorymanagement.inventory.config.properties.PersistenceProperties;
